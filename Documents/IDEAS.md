...
2. **Standalone EXE** - bundle JRE with launch4j; without this ~90% of potential players won't bother
3. **Deployment and release** - full exe test, update screenshots, promo video, publish on itch.io ("pay what you want")
4. **Ko-fi** - add badge to README and itch.io page after release (Ko-fi: https://ko-fi.com/david7789)

**Note:** Low priority - fun/hobby only. Java + Slick2D is a dead framework. Not a realistic earner unless polished + easily installable. Only work on this if enjoying it.

See `Claude-Feedback.md` for full assessment.
...
### Ice Area
- Special Ice Area = Movement slides like Pokemon gym
