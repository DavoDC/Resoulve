...
See [Key Mappings](https://github.com/DavoDC/Resoulve/wiki) in the wiki.
...
- **Language:** Java
- **Framework:** [Slick2D](https://slick.ninjacave.com/) (LWJGL-based 2D game framework)
- **Architecture:** State-based game engine (`StateBasedGame`)
- **Custom systems:** Audio server, input manager, font manager, particle engine
